package net.guttershark.util
{
	...
	public class ArrayPeer 	{
		 ...
		 * 
		 * <p>The conditons are evaluated and compared strictly equal
		 * and the item must match all conditions to be in the returned array.</p>
		 * 
		 * <p>Conditions with Class, Function or RegExp as the expected values are
		 * subject to some additional rules regarding matches.</p>
		 * 
		 * <dl>
		...
		public static function find(array:Array,conditions:Object,options:Object=null):* 		{
			...
			if(options.find == FIRST)			{
				i = 0;
				n = array.length;
				while(i < n) if(matches(item = array[i++],conditions)) return item; 
				return null;
			}
		 ...
		 * @param options Find first,last or all -  see (ArraySearch.ALL, ArraySearch.LAST, ArraySearch.FIRST).
		 */
