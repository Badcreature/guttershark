...
package deng.fzip
{
	...
	public class FZip extends EventDispatcher
	{
		...
		protected function addEventHandlers():void {
			...
			urlStream.addEventListener(IOErrorEvent.DISK_ERROR, defaultErrorHandler);
            urlStream.addEventListener(IOErrorEvent.NETWORK_ERROR, defaultErrorHandler);
            urlStream.addEventListener(IOErrorEvent.VERIFY_ERROR, defaultErrorHandler);
