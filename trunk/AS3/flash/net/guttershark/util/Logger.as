package net.guttershark.util
{
	...
	/**
	 * The Logger class is a utility class for logging output,
	 ...
	 * </listing>	
	 * 
	 * The above example is the most basic example. You can also add in "filters" to 
	 * filter out traces. The second parameter to any method on the Logger class 
	 * can be any filter you want.
	 * 
	 ...
	 * </listing>
	 * 
	 * In this example - there are two filters on the logger (Startup, Preloading).
	 * Any filter message that comes through the logger that matches on of the allowable
	 * filters will get traced. Others will be suppressed. So the message3 message will not 
	 * be shown because it's not an allowable filter.
	 */
	public class Logger
	{
