package net.guttershark.util
{
	...
	public class DateUtil2
	{
		...
		/**
		 * Get the remaing time (seconds,hours,days,years) until the
		 * specified date will happen.
		 * 
		 * @param	futureDate	The target future date
		 * 
		 * @return 	Object	a generic object. {seconds:x,minutes:x,hours:x,days:x,years:x}
		 */ 
