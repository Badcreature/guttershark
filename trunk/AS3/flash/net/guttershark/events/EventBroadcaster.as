package net.guttershark.events
{
	...
	/**
	 * The EventBroadcaster is used as a static instance of an event dispatcher.
	 * 
	 * <p>The interface is the same as an instance of EventDispatcher,
	 * but in this case, the methods are static, and internally there is
	 * one instance of EventDispatcher used.</p>
	 * 
	 * <p>
	 * Here is an example using the EventBroadcaser:
	 * </p>
	 * 
	 * <listing>	
