...
package
{
	...
	import net.guttershark.control.shells.AkamaiStreaming;
	
	import gs.TweenMax;	
	
	public class AkamaiTest extends AkamaiStreaming
	{
		...
		override protected function akamaiIdentComplete():void
		{
