package net.guttershark.remoting.paging
{
	...
	import net.guttershark.remoting.events.PageEvent;
	import net.guttershark.remoting.errors.PageError;
	 ...
	 */
	[Event(name=CallEvent.RETRY,type="net.guttershark.remoting.events.CallEvent")];
	 ...
	 * @eventType net.guttershark.remoting.events.CallEvent
	 */
	[Event(name=CallEvent.TIMEOUT,type="net.guttershark.remoting.events.CallEvent")];
	
	/**
	 * Dispatched when all one page has have been receied.
	 * 
	 * @eventType net.guttershark.remoting.events.PageEvent
	 */
	[Event(name=PageEvent.RECEIVED,type="net.guttershark.remoting.events.PageEvent")];
	 ...
	 * @eventType net.guttershark.remoting.events.PageEvent
	 */
	[Event(name=PageEvent.FAILED,type="net.guttershark.remoting.events.PageEvent")];
	 ...
	 * @eventType net.guttershark.remoting.events.PageEvent
	 */
	[Event(name=PageEvent.RETRIEVING,type="net.guttershark.remoting.events.PageEvent")];
	 ...
	 * @eventType net.guttershark.remoting.events.PageEvent
	 */
	[Event(name=PageEvent.BUFFER_FULL,type="net.guttershark.remoting.events.PageEvent")];
	 ...
	 * @eventType net.guttershark.remoting.events.PageEvent
	 */
	[Event(name=PageEvent.RELEASED_ALL,type="net.guttershark.remoting.events.PageEvent")];
